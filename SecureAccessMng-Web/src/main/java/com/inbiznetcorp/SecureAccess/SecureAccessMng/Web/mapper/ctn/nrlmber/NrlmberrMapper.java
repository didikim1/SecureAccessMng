package com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.ctn.nrlmber;
...
@Master
@Repository("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.ctn.nrlmber.NrlmberrMapper")
public interface NrlmberrMapper
{
	/**
	* 페이징 갯수
	* @param paramMap
