package com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqDepoly;
...
@Master
@Repository("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqDepoly.EqDepolyMapper")
public interface EqDepolyMapper
{
	/**
	* 페이징 갯수
	* @param paramMap
