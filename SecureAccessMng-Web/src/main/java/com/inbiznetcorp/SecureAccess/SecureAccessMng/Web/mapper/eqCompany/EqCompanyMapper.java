package com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqCompany;
...
@Master
@Repository("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqCompany.EqCompanyMapper")
public interface EqCompanyMapper
{
	/**
	* 페이징 갯수
	* @param paramMap
