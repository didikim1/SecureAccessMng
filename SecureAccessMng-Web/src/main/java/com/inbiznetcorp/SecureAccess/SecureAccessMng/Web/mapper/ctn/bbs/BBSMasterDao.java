package com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.ctn.bbs;
...
@Master
@Repository("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.ctn.bbs.BBSMasterDao")
public interface BBSMasterDao
{
    /**
    * 페이징 갯수
    * @param paramMap
    ...
    */
     ...
     * @return
     */
    public java.util.List<MyCamelMap> ListAllData(MyMap paramMap);
