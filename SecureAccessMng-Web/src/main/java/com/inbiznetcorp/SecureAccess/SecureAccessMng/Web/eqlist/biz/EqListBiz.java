package com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.eqlist.biz;
...
import com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqlist.EqListMapper;

@Service("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.svinfo.biz.EqListBiz")
public class EqListBiz
{
	private static final org.apache.log4j.Logger Logger = org.apache.log4j.Logger.getLogger(EqListBiz.class.getName());

	@Resource(name = "com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqlist.EqListMapper")
	EqListMapper mMapper;
