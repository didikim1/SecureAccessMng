package com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.ctn.entrprsmber.biz;
...
import com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.ctn.entrprsmber.EntrprsmberMapper;

@Service("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.ctn.entrprsmber.biz.EntrprsmberBiz")
public class EntrprsmberBiz
{
    private static final org.apache.log4j.Logger Logger = org.apache.log4j.Logger.getLogger(EntrprsmberBiz.class.getName());

    @Resource(name = "com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.ctn.entrprsmber.EntrprsmberMapper")
    EntrprsmberMapper mMapper;
    ...
    public BasicBean ListData(MyMap paramMap) {
            ...
            paramMap.put("sidx", paramMap.getStr("sidx", "seq"));
