package com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.eqCompany.service;
...
import com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqCompany.EqCompanyMapper;

@Service("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.eqCompany.service.EqCompanyBiz")
public class EqCompanyBiz 
{
	private static final org.apache.log4j.Logger Logger = org.apache.log4j.Logger.getLogger(EqIdcBiz.class.getName());

	@Resource(name = "com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqCompany.EqCompanyMapper")
	EqCompanyMapper mMapper;
