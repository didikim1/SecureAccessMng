package com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqAllowIP;
...
@Master
@Repository("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqAllowIP.EqAllowIPMapper")
public interface EqAllowIPMapper
{
	/**
	* 페이징 갯수
	* @param paramMap
