package com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.eqDepoly.biz;
...
import com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqDepoly.EqDepolyMapper;

@Service("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.eqDepoly.biz.EqDepolyBiz")
public class EqDepolyBiz 
{
	@Resource(name = "com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqDepoly.EqDepolyMapper")
	EqDepolyMapper mMapper;
	...
	*/
	...
	public int RegisterDataDepoly(MyMap paramMap) {
		return mMapper.RegisterDataDepoly(paramMap);
	}
