package com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.ctn.dpament;
...
@Master
@Repository("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.ctn.dpament.DpamentMapper")
public interface DpamentMapper
{
	/**
	* 페이징 갯수
	* @param paramMap
