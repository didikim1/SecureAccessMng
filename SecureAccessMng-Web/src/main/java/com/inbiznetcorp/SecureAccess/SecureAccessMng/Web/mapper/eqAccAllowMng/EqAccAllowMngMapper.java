package com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqAccAllowMng;
...
@Master
@Repository("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqAccAllowMng.EqAccAllowMngMapper")
public interface EqAccAllowMngMapper
{
    /**
     * 페이징 갯수
     * @param paramMap
