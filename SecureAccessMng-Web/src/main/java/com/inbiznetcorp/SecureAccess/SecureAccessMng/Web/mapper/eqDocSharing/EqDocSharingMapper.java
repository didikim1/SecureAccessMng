package com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqDocSharing;
...
@Master
@Repository("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.eqDocSharing.EqDocSharingMapper")
public interface EqDocSharingMapper
{
	/**
	* 페이징 갯수
	* @param paramMap
