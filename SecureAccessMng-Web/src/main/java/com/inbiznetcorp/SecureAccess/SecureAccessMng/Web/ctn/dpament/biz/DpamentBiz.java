...
import com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.ctn.dpament.DpamentMapper;

@Service("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.ctn.dpament.biz.DpamentBiz")
public class DpamentBiz
{
    @Resource(name="com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.ctn.dpament.DpamentMapper")
    DpamentMapper mMapper;
