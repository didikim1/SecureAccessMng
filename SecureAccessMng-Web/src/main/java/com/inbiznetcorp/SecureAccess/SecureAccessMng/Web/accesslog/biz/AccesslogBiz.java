package com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.accesslog.biz;
...
import com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.accesslog.AccesslogMapper;

@Service("com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.accesslog.biz.AccesslogBiz")
public class AccesslogBiz
{
    private static final org.apache.log4j.Logger Logger = org.apache.log4j.Logger.getLogger(AccesslogBiz.class.getName());

    @Resource(name = "com.inbiznetcorp.SecureAccess.SecureAccessMng.Web.mapper.accesslog.AccesslogMapper")
    AccesslogMapper mMapper;
